    ...
    try {
      ...
      try {
        const response = await fetch('/api/analyze', {
          ...
          body: JSON.stringify({ url: searchQuery, language })
        });
        ...
        data = {
          ...
          platform: template,
          template: template,
          title: aiData.title || searchQuery || "Untitled",
      ...
      <AnimatePresence>
        {isVisible && !isSearchOpen && (
          <motion.button
            ...
            className="fixed bottom-8 right-8 z-40 w-16 h-16 flex items-center justify-center"
          >
            <svg className="w-full h-full text-[#21DBA4]" viewBox="0 0 80 80" fill="none">
              <g filter="url(#filter0_d_button_floating_main)">
              ...
              <defs>
                <filter id="filter0_d_button_floating_main" x="0" y="0" width="80" height="80" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
