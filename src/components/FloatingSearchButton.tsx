      ...
      <AnimatePresence>
        {isVisible && !isSearchOpen && (
          <motion.button
            ...
            className="fixed bottom-8 right-8 z-40 w-16 h-16 flex items-center justify-center rounded-full text-[#21DBA4] bg-white dark:bg-[#1e1e1e] shadow-lg shadow-black/10"
            style={{
              filter: 'drop-shadow(0px 4px 10px rgba(0, 0, 0, 0.15))',
              WebkitFilter: 'drop-shadow(0px 4px 10px rgba(0, 0, 0, 0.15))'
            }}
          >
            <svg
              ...
              style={{ display: 'block' }}
            >
              <rect x="5" y="5" width="70" height="70" rx="35" fill="currentColor" className="text-white dark:text-[#1e1e1e]" />
