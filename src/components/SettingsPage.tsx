...
import { User, Bell, Moon, Shield, ChevronRight, LogOut, Globe } from 'lucide-react';
...
const SettingsPage = ({ onLogout, onNavigate, isDarkMode, toggleDarkMode, language, toggleLanguage }: SettingsPageProps) => {
