...
const MobileHeader = (props: MobileHeaderProps) => {
   ...
   return (
      <div className="sticky top-0 z-30 w-full bg-[rgba(255,255,255,0.9)] dark:bg-[rgba(18,18,18,0.9)] backdrop-blur-md border-b border-gray-100 dark:border-gray-800 px-4 h-[60px] flex items-center justify-between md:hidden transition-colors duration-300">
