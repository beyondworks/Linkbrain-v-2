...
const MobileHeader = (props: MobileHeaderProps) => {
   ...
   return (
      <div className="sticky top-0 z-30 w-full bg-white dark:bg-[#121212] border-b border-gray-100 dark:border-gray-800 px-8 py-8 flex items-center justify-between md:hidden transition-colors duration-300">
